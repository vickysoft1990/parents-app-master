 ...
 */
public class Marks extends Fragment implements OnPageChangeListener, OnLoadCompleteListener, OnErrorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentFile = new File(Environment.getExternalStorageDirectory() + "/School/marks.pdf");
        currentFile.delete();

        Ion.with(getActivity())
                .load("https://www.comega.in/schools/sdsbkd/billing/fees.php?refid=" + AppController.getInstance().preferences.getString("user_id", "") + "&academic=" + AppController.getInstance().preferences.getString("academic_year", "") + "&marks")
                .write(currentFile)
